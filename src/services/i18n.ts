...
const messages: Record<LocaleCode, MessageTree> = {
  "zh-CN": {
    ...
    settings: {
      ...
      runtimeDescriptionInstalling: "正在下载并配置本地运行环境，请耐心等待当前安装流程完成。",
      runtimeDescriptionFailed: "安装未完成，请查看下方日志并重新安装。",
      runtimeDescriptionMissing: "当前设备尚未安装本地运行环境，安装后即可直接处理会议文件。",
  ...
  "en-US": {
    ...
    settings: {
      ...
      runtimeDescriptionInstalling: "Downloading and preparing the local runtime. Please wait for the current install to finish.",
      runtimeDescriptionFailed: "Installation did not finish. Check the log below and reinstall.",
      runtimeDescriptionMissing: "This device does not have the local runtime yet. Install it to process meeting files directly.",
