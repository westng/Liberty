...
const messages: Record<LocaleCode, MessageTree> = {
  "zh-CN": {
    ...
    settings: {
      ...
      managedRuntimeHint: "安装并管理 Liberty 内置的 Python、依赖、ffmpeg，并下载默认 FunASR 模型。",
      runtimeStatus: "当前状态",
      ...
      runtimeDescriptionInstalling: "正在展开内置运行环境并下载默认模型，请等待当前流程完成。",
      runtimeDescriptionFailed: "安装未完成，请查看下方日志并重新安装。",
      runtimeDescriptionMissing: "当前设备尚未完成本地运行环境初始化，安装并下载模型后即可直接处理会议文件。",
  ...
  "en-US": {
    ...
    settings: {
      ...
      managedRuntimeHint:
        "Install and manage Liberty bundled Python, dependencies, ffmpeg, then download the default FunASR models.",
      ...
      runtimeInstallAction: "Install and Download Models",
      ...
      runtimeDescriptionInstalling: "Expanding the bundled local runtime and downloading the default models. Please wait for the current install to finish.",
      runtimeDescriptionFailed: "Installation did not finish. Check the log below and reinstall.",
      runtimeDescriptionMissing: "This device has not finished local runtime initialization yet. Install it and download the default models to process meeting files directly.",
