...
- 支持桌面宠物、宠物中心、LP 钱包、宠物商店、个人仓库、商品详情窗口和原生桌宠渲染。
...
宠物链路是主会议流程之外的本地陪伴系统。应用启动会尝试同步桌宠状态，但宠物加载失败不会阻塞主窗口。
...
- `宠物中心`：查看宠物等级、经验、阶段、事件、桌面行为和互动入口。
...
- 会议人员、部门、排序和会议记录人。
- 宠物档案、桌面行为设置、成长事件、阶段装扮。
- LP 钱包、商品仓库、经济流水和里程碑计数。
...
- 宠物系统是本地奖励和陪伴系统，不包含真钱支付、抽卡、交易或排行榜。
